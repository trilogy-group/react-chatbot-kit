...
const UserChatMessage = ({
  ...
  return (
    <div className="react-at-chatbot-kit-user-chat-message-container">
      <ConditionallyRender
        ...
        elseShow={
          <div className="react-at-chatbot-kit-user-chat-message">
            {message}
            <div className="react-at-chatbot-kit-user-chat-message-arrow"></div>
          </div>
        }
      />
      <ConditionallyRender
        ...
        elseShow={
          <div className="react-at-chatbot-kit-user-avatar">
            <div className="react-at-chatbot-kit-user-avatar-container">
              <UserIcon className="react-at-chatbot-kit-user-avatar-icon" />
            </div>
          </div>
        }
      />
